								...
								<div class="list-group list-group-flush">
									...
									<div class="list-group-item d-flex align-items-start p-16pt">
										...
										<div class="flex">
											...
											<a href=""
											   class="text-70 text-underline">read more</a>
									...
									<div class="list-group-item d-flex align-items-start p-16pt">
										...
										<div class="flex">
											...
											<a href=""
											   class="d-flex align-items-center border-1 rounded mb-0 p-8pt">
												<span class="mr-8pt p-8pt bg-dark rounded"
								...
								<div class="card-body position-relative o-hidden p-0">
									<div class="chart z-0"
										...
										<canvas id="viewsChart"
												class="chart-canvas js-update-chart-line-2nd-accent"
									...
									<div class="card mb-md-0">
										...
										<div class="card-body">
											...
											<div class="text-center">
												<a href=""
												   class="btn btn-sm btn-outline-secondary">View employees</a>
											</div>
										</div>
									</div>
								...
								<div class="col-md-6">
									...
									<div class="card mb-md-0">
										...
										<div class="card-body">
											...
											<div class="text-center">
												<a href=""
												   class="btn btn-sm btn-outline-secondary">View departments</a>
											</div>
										</div>
									</div>
