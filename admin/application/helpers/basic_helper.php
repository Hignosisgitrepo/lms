...
if (!function_exists('setting')) {
    ...
    function setting($key, $code) {
		$CI =& get_instance();
		return !empty($value = $CI->common_model->getValueByKey($key, $code)) ? $value : false;
	}
 ...
 * 
 */
if (!function_exists('language_folder')) {
    
    function language_folder($lang = '')
    {
        $CI =& get_instance();
        return !empty($value = $CI->common_model->getLanguageDetail($lang)) ? $value : false;
    }
