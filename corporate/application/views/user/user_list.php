                        ...
                        <tr>
                           <th>
                              <a href="javascript:void(0)"
                                 class="sort"
                                 data-sort="js-lists-values-categoryname"><?php echo $text_name; ?></a>
                           </th>
						   ...
						   <th><a href="javascript:void(0)"
                              class="sort"
                              data-sort="js-lists-values-email"><?php echo $text_created; ?></a></th>
                        ...
                        <tr>
                           <td>
                              <div class="d-flex flex-column">
                                 <p class="mb-0"><strong class="js-lists-values-categoryname"><?php echo $res['name']; ?> </strong></p>
                                 <small class="js-lists-values-email text-50"><?php echo $res['email']; ?></small>
                              </div>
                           </td>
                           <td>
