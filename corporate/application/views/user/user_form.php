                  ...
                  <div class="card-header">
                     ...
                     <form enctype="multipart/form-data" id="user-form" class="form-horizontal">
                        <div class="row">
                              ...
                              <div class="form-group">
                                 ...
                                 <select class="form-control" id="usergroup_id" name="usergroup_id">
                                    ...
                                    <?php foreach($user_groups as $group): ?>
									  <?php if($group->client_user_group_id == $user_group_id) { ?>
										<option value="<?php echo $group->client_user_group_id; ?>" selected="selected"><?php echo $group->user_group_name; ?></option>
									  <?php } else { ?>
									    <option value="<?php echo $group->client_user_group_id; ?>"><?php echo $group->user_group_name; ?></option>
									  <?php } ?>
                                    <?php endforeach; ?>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label><?php echo $text_designation; ?></label>
                                 <select class="form-control" id="designation" name="designation">
                                    <option value=""><?php echo $text_select; ?></option>
                                    <?php foreach($designations as $designtn): ?>
									  <?php if($designation == $designtn->corporate_designation_id) { ?>
										<option value="<?php echo $designtn->corporate_designation_id; ?>" selected="selected"><?php echo $designtn->designation_name; ?></option>
									  <?php } else { ?>
										<option value="<?php echo $designtn->corporate_designation_id; ?>"><?php echo $designtn->designation_name; ?></option>
									  <?php } ?>
                                    <?php endforeach; ?>
                                 </select>
                              </div>
...
<script>
	function addUser() {
		...
		$.ajax({
			...
			method: 'POST',
			data: {first_name: first_name, last_name: last_name, email_id: email_id, phone_no: phone_no, usergroup_id: usergroup_id, designation: designation},
			dataType: 'json',	
...
<script>
	function editUser(user_id) {
		...
		$.ajax({
			...
			method: 'POST',
			data: {user_id: user_id, first_name: first_name, last_name: last_name, email_id: email_id, phone_no: phone_no, usergroup_id: usergroup_id, designation: designation},
			dataType: 'json',	
			success: function(json){
				if(json['success']) {
					window.location = url_path;
