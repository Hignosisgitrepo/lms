...
<div class="mdk-header-layout__content page-content ">
	...
	<div class="mdk-box bg-primary js-mdk-box mb-0" data-effects="blend-background" style="background-color:#a9acc5!important">
		...
		<div class="container page__container">
			...
			<div class="position-relative carousel-card">
				<div class="js-mdk-carousel row d-block"
					...
					<div class="mdk-carousel__content">
					  <?php foreach($other_trainings as $other) { ?>
						<?php $b64_tmid = urlencode(base64_encode($other->training_master_id)) ; ?>
						<div class="col-sm-3">
							...
							<div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
								...
								<a href="<?php echo base_url(); ?>search-training/<?php echo $b64_tmid; ?>"
								   class="js-image"
								   data-position="">
								...
								<div class="mdk-reveal__content">
									<div class="card-body">
										<div class="d-flex">
											<div class="flex">
												<a class="card-title"
												   href="student-course.html"><?php echo $other->training_name; ?></a>
