            ...
            <div class="card m-0">
               <div class="card-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="maintainance_name" name="maintainance_name" placeholder="<?php echo $entry_name; ?>" value="<?php echo $maintainance_name; ?>" readonly />
                        </div>
                     </div>
