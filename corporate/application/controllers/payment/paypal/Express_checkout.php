...
class Express_checkout extends ClientController
{
    ...
    function index()
    {
		...
		$this->loadViews("paypal/express_checkout/index", $this->global, $cart, NULL);
    }
    ...
    function GetExpressCheckoutDetails()
    {
        ...
        else
        {
            ...
            // Example - Load Review Page
			$this->loadViews("paypal/express_checkout/review", $this->global, $cart, NULL);
        }
    }
    ...
    function OrderComplete()
    {
        ...
        $cart = $this->session->userdata('shopping_cart');
        //$this->order_model->addOrder($cart, $this->global['customer_id']);
		...
		$this->loadViews("paypal/express_checkout/payment_complete", $this->global, $cart, NULL);
    }
