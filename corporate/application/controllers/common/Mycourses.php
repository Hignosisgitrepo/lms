...
class Mycourses extends ClientController {
	...
	public function index() {
	    ...
	    $results = $this->order_model->getOrders($user_id);
	    ...
	    $this->loadViews("common/mycourses", $this->global, $data, NULL);
	}
	...
	public function view($b64_tmid = NULL) {
	    ...
	    $trainer_data = $this->common_model->getTrainerData($course_data[0]->created_by);
	    ...
	    $this->loadViews("common/course-view", $this->global, $data, NULL);
	}
}
