<?php $this->load->view('includes/header'); ?>
                    ...
                    <div class="hero container page__container text-center text-md-left py-112pt">
                        <h1 class="text-white text-shadow">Learn to Code DEV OOPs</h1>
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?php echo base_url('assets/common/images/256_luke-porter-261779-unsplash.jpg'); ?>"
                                                             alt="Avatar"
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?php echo base_url('assets/common/images/256_michael-dam-258165-unsplash.jpg'); ?>"
                                                             alt="Avatar"
                                                             class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body d-flex align-items-center">
                                            <div class="avatar-group flex">
                                                <div class="avatar avatar-xs"
                                                     ...
                                                     data-placement="top"
                                                     title="Janell D.">
                                                    <a href=""><img src="<?php echo base_url('assets/common/images/256_rsz_1andy-lee-642320-unsplash.jpg'); ?>"
                                                             alt="Avatar"
                                                             class="avatar-img rounded-circle"></a>
                                                </div>
                                            </div>
                            ...
                            <div class="card posts-card mb-0">
                                <div class="posts-card__content d-flex align-items-center flex-wrap">
                                    <div class="avatar avatar-lg mr-3">
                                        <a href="blog-post.html"><img src="<?php echo base_url('assets/common/images/paths/invision_200x168.png'); ?>"
                                                 alt="avatar"
