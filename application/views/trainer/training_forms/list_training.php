<div class="pt-32pt">
	<div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
		...
		<div class="row"
			 role="tablist">
			<div class="col-auto">
				<a href="<?php echo site_url('add_training')?>"
	                    ...
	                    <div class="media">
	                        ...
	                        <div class="media-body">
	                            ...
	                            <p class="lh-1">
	                                ...
	                                <span class="text-50 small font-weight-bold"><?php echo $trainer_name; ?></span>
	                            </p>
	                        </div>
	                    </div>

	                    <p class="my-16pt text-70"><?php echo $result['training_description']; ?></p>

	                    <div class="mb-16pt">
						<?php if(!empty($course_concepts)) { ?>
					<?php foreach($course_concepts as $result1): ?>
						<?php if($result['training_master_id']==$result1['training_master_id']){ ?>
	                        <div class="d-flex align-items-center">
								<span class="material-icons icon-16pt text-50 mr-8pt">check</span>

					<p class="flex text-50 lh-1 mb-0"><small><?php echo $result1['course_concepts']; ?></small></p>
