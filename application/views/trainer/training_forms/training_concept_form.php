<form action="#" class="concept_form" novalidate>
		<div class="row">
			...
			<div class="col-xl-12 card">
				<div class="card-body">
					...
					<button type="button" id="newBtn" onclick="addConcept();"  class="btn btn-info"><i class="fa fa-plus-circle"></i></button>
					</div>
	...
	<div class="text-right">
		...
		<button type="button" data-value="2" id="next_button_2" class="next_button btn btn-primary">Next</button>
	</div>
</form>