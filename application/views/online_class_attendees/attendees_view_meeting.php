                        ...
                        <div class="accordion__menu collapse" id="course-toc-<?php echo $section['training_section_id']; ?>">
                                ...
                                <?php foreach($section['sub_section'] as $sub_key => $sub): ?>
                                    ...
                                    <?php if ($training_details[0]['training_type'] == 'Online') { ?> 
                                        <span class="text-muted  ml-sm-auto flex-column">&nbsp; <button id="<?php echo $training_master_id; ?>_<?php echo $training_section_id; ?>_<?php echo $training_section_detail_id; ?>" data-value="<?php echo $training_master_id; ?>_<?php echo $training_section_id; ?>_<?php echo $training_section_detail_id; ?>" href="<?php echo site_url('create_meeting').'/'.$training_master_id.'/'.$training_section_id.'/'.$training_section_detail_id ?>" class="create_meeting btn btn-outline-white mb-16pt mb-sm-0 mr-sm-16pt">Create meeting <i class="material-icons icon--right">play_circle_outline</i></a></span>
                                    <?php } ?>
                                    </div>
