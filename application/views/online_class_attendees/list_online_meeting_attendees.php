    ...
    <div class="page-section">
        ...
        <div class="row">
			<?php if(!empty($online_training_list)) { ?>
                ...
                <?php $training_section_id = urlencode(base64_encode($result['training_section_id'])); ?>
                <?php $training_section_detail_id = urlencode(base64_encode($result['training_section_detail_id'])); ?>
                <?php $meeting_id = urlencode(base64_encode($result['meeting_id'])); ?>
                <?php $customer_id = urlencode(base64_encode($result['customer_id'])); ?>
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="<?php echo site_url('view_meeting_course'); ?>/<?php echo $training_master_id.'/'.$training_section_id.'/'.$training_section_detail_id.'/'.$customer_id; ?>" class="btn btn-primary">View course</a>
                            </div>
                        </div>
