                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__menu collapse" id="course-toc-<?php echo $section['training_section_id']; ?>">
                                ...
                                <?php foreach($section['sub_section'] as $sub_key => $sub): ?>
                                    ...
                                    <?php $meeting_id = urlencode(base64_encode($sub['meeting_id'])); ?>
                                    <?php $attendee_id = urlencode(base64_encode($sub['attendee_id'])); ?>
                                    <?php $customer_id = urlencode(base64_encode($sub['customer_id'])); ?>
                                    <?php $isMeetingHost = $sub['isMeetingHost']; ?>
                                    ...
                                    <div class="play_video"> <a class="flex" id="<?php echo $sub['video_file_path']; ?>" href="#"><?php echo $sub['sub_section_name']; ?></a> </div> <br>
                                    <span class="text-muted">&nbsp; 1m 10s</span>
                                    <?php if ($training_details[0]['training_type'] == 'Online' && $attendee_id == '') { ?> 
                                        <span class="text-muted  ml-sm-auto flex-column">&nbsp; <button data-value="<?php echo $training_master_id.'_'.$training_section_id.'_'.$training_section_detail_id.'_'.$meeting_id.'_'.$customer_id; ?>" class="attend_meeting btn btn-outline-dark mb-16pt mb-sm-0 mr-sm-16pt">Attend meeting <i class="material-icons icon--right">play_circle_outline</i></a></span>
                                    <?php } else { ?>
                                        <!-- <span class="text-muted  ml-sm-auto flex-column">&nbsp; <button id="join_meeting" data-value="<?php echo $meeting_id.'_'.$attendee_id.'_'.$customer_id; ?>" class="btn btn-outline-dark mb-16pt mb-sm-0 mr-sm-16pt">Join meeting <i class="material-icons icon--right">play_circle_outline</i></a></span> -->

                                        <span class="text-muted  ml-sm-auto flex-column">&nbsp; <a target="_blank" href="<?php echo base_url('start_meeting/'.$meeting_id.'/'.$attendee_id.'/'.$customer_id.'/'.$isMeetingHost); ?>" class="start_meeting btn btn-outline-dark mb-16pt mb-sm-0 mr-sm-16pt">Join meeting <i class="material-icons icon--right">play_circle_outline</i></a></span>
                                    <?php } ?>
                                    </div>
...
<script type="text/javascript">
    var create_atteend_for_online = "<?php echo site_url('create_meeting'); ?>";
