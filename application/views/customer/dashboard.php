...
<div class="container page__container">
	<div class="page-section">
		...
		<div class="alert alert-soft-accent alert-dismissible fade show"
			 role="alert" id="trainer_success_div" style="display:none">
		</div>
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item active">
							...
							<a class="card border-0 mb-0"
							   href="">
								<img src="<?php echo base_url('assets/common/images/achievements/flinto.png'); ?>"
									 alt="Flinto"
									 class="card-img"
								...
								<span class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
									...
									<span class="row flex-nowrap">
										<span class="col-auto text-center d-flex flex-column justify-content-center align-items-center">
											<img src="<?php echo base_url('assets/common/images/illustration/achievement/128/white.png'); ?>"
												 width="64"
												 alt="achievement">
										</span>
										<span class="col d-flex flex-column">
						...
						<div class="carousel-item">
							...
							<a class="card border-0 mb-0"
							   href="">
								<img src="<?php echo base_url('assets/common/images/achievements/angular.png'); ?>"
								...
								<span class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
									<span class="row flex-nowrap">
										...
										<span class="col d-flex flex-column">
											<span class="text-right flex mb-16pt">
												<img src="<?php echo base_url('assets/common/images/paths/angular_64x64.png'); ?>"
													 width="64"
													 alt="Angular fundamentals"
													 class="rounded">
											</span>
							...
							<div class="flex">
								<div class="d-flex align-items-center">
									<div class="rounded mr-12pt z-0 o-hidden">
										<div class="overlay">
											<img src="<?php echo base_url('assets/common/images/paths/angular_40x40@2x.png'); ?>"
												 width="40"
												 height="40"
												 alt="Angular"
												 class="rounded">
							...
							<div class="col-12 col-sm-6">
								...
								<div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
									...
									<a href="student-take-course.html"
									   class="js-image"
									   data-position="">
										<img src="<?php echo base_url('assets/common/images/paths/angular_430x168.png'); ?>"
											 alt="course">
							...
							<div class="col-12 col-sm-6">
								...
								<div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
									...
									<a href="student-take-course.html"
									   class="js-image"
									   data-position="">
										<img src="<?php echo base_url('assets/common/images/paths/swift_430x168.png'); ?>"
											 alt="course">
										<span class="overlay__content align-items-start justify-content-start">
											<span class="overlay__action card-body d-flex align-items-center">
												<i class="material-icons mr-4pt">play_circle_outline</i>
							...
							<div class="col-12 col-sm-6">
								...
								<div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
									...
									<a href="student-take-course.html"
									   class="js-image"
									   data-position="">
										<img src="<?php echo base_url('assets/common/images/paths/wordpress_430x168.png'); ?>"
											 alt="course">
										<span class="overlay__content align-items-start justify-content-start">
											<span class="overlay__action card-body d-flex align-items-center">
												<i class="material-icons mr-4pt">play_circle_outline</i>
							...
							<div class="col-12 col-sm-6">
								...
								<div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
									...
									<a href="student-take-course.html"
									   class="js-image"
									   data-position="left">
										<img src="<?php echo base_url('assets/common/images/paths/react_430x168.png'); ?>"
											 alt="course">
										<span class="overlay__content align-items-start justify-content-start">
											<span class="overlay__action card-body d-flex align-items-center">
												<i class="material-icons mr-4pt">play_circle_outline</i>
					...
					<div class="card-body d-flex align-items-center">
						<a href="student-take-quiz.html"
						   class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
							<img src="<?php echo base_url('assets/common/images/paths/typescript_200x168.png'); ?>"
			...
			<div class="card-group-row__col col-md-6">
				...
				<div class="card card-group-row__card card-sm">
					<div class="card-body d-flex align-items-center">
						<a href="student-take-quiz.html"
						   class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
							<img src="<?php echo base_url('assets/common/images/paths/angular_200x168.png'); ?>"
								 alt="Angular Fundamentals"
								 class="avatar-img rounded">
							<span class="overlay__content"></span>
						</a>
